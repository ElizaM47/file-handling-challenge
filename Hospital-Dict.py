...
print("John's allergies:", patients["P881"]["allergies"])  # ['Penicillin']
 ...
 "P881": {"name": "Enoch nduta", "allergies": ["Penicillin"], "ward": "ICU"},
    "P882": {"name": "Mary ngugi", "allergies": ["Smoke"], "ward": "Ward 4A
             print("Cardiologist on duty:", staff[101]['name'])  # Dr. Smith
print("John's allergies:", patients["P881"]["allergies"])  # ['Penicillin']print("Cardiologist on duty:", staff[101]['name'])  # Dr. Smith
print("John's allergies:", patients["P881"]["allergies"])  # ['Penicillin']