...
print("Ward 4A:", ward_4a zomo')  
# Output: ['Bed1: Robert', 'Bed2: Fatima', 'Bed3: James', 'Bed4: Aisha' ,'Bed5: zomo']


discharged = ward_4a.pop(1)
print(f"Discharged: {disc3, → Remaining: {ward_4a}")  
# Output: Discharged: Bed2: Fatima → Remaining: 
['Bed1: Robert', 'Bed3: James', 'Bed4: Aisha']
ischarged = ward_4a.pop(4
                        )
